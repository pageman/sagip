...
urlpatterns = patterns('',
	...
	url(r'^turismo/', 'sagip.views.turismo', name='turismo'),
	url(r'^game/(?P<page_id>\d+)/$', 'sagip.views.game', name='game'),
	url(r'^sms/', 'sagip.views.send_sms', name='send_sms'),
	url(r'^send_alarm/', 'sagip.views.send_alarm', name='send_alarm'),
